...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ae6203fe5b1f26759869c83c0aa2f81a5f071f8b21e137f20d957d6ae88fb169_1' => 'getAe6203fe5b1f26759869c83c0aa2f81a5f071f8b21e137f20d957d6ae88fb1691Service',
            ...
            'b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_1' => 'getB5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac991Service',
            'b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_2' => 'getB5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac992Service',
            'b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_3' => 'getB5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac993Service',
    ...
    /**
     * Gets the 'ae6203fe5b1f26759869c83c0aa2f81a5f071f8b21e137f20d957d6ae88fb169_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getAe6203fe5b1f26759869c83c0aa2f81a5f071f8b21e137f20d957d6ae88fb1691Service()
    {
        return $this->services['ae6203fe5b1f26759869c83c0aa2f81a5f071f8b21e137f20d957d6ae88fb169_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/Login/app/cache/dev/annotations', true);
    }
    ...
    /**
     * Gets the 'b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getB5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac991Service()
    {
        return $this->services['b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getB5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac992Service()
    {
        return $this->services['b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getB5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac993Service()
    {
        return $this->services['b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/Login/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'test', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_3d3a4b60ef8d46d7ef0d08bfb3c88a5d4c7d47c15d7cea8afd0470e981c1de54');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_3d3a4b60ef8d46d7ef0d08bfb3c88a5d4c7d47c15d7cea8afd0470e981c1de54');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_3d3a4b60ef8d46d7ef0d08bfb3c88a5d4c7d47c15d7cea8afd0470e981c1de54');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\xampp\\htdocs\\Login\\src\\Login\\LoginBundle\\Resources\\config\\doctrine' => 'Login\\LoginBundle\\Entity'));
        ...
        $f->setProxyDir('C:/xampp/htdocs/Login/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/Login/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('ae6203fe5b1f26759869c83c0aa2f81a5f071f8b21e137f20d957d6ae88fb169_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/Login/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/Login/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/Login/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/Login/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Login/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/Login/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/Login/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_1'), 1 => $this->get('b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_2'), 2 => $this->get('b5d0c668748b922498d8893b5edf4bbc7ef2516be2292e972f2da86d40b0ac99_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/Login/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/xampp/htdocs/Login/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/Login/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\Login\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\Login\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\Login\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\Login\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\Login\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\Login\\src\\Login\\LoginBundle/Resources/views', 'LoginLogin');
        $instance->addPath('C:\\xampp\\htdocs\\Login\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\xampp\\htdocs\\Login\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\Login\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/Login/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\Login\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\xampp\\htdocs\\Login\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/Login/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/Login/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/Login/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/Login/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/Login/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/Login/app/logs',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/Login/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/xampp/htdocs/Login/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/Login/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/Login/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/Login/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/Login/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/Login/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/Login/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/Login/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/Login/app/cache/dev/doctrine/orm/Proxies',
